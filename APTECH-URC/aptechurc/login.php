  			...
  			<div class="card col-md-3">
  				<div class="card-body">
  					...
  					<form id="login-form" >
  						...
  						<center><button class="btn btn-outline-primary btn-block">Login</button></center>
  						<br>
  						<label class="control-label"><a href="#" target="a_blank">Developed By : Taha And Usman</a>
  					</form>
  				</div>
  			</div>
  		</div>
